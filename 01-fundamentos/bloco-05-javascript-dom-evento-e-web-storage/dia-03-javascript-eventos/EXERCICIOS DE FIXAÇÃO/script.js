...
myWebpage.addEventListener("dblclick", function(){
 window.location.href = "https://pt.stackoverflow.com/questions/3312/como-redirecionar-o-usu%C3%A1rio-para-outra-p%C3%A1gina-em-javascript-jquery";
})

myWebpage.addEventListener("mouseover", function(){
  myWebpage.style.fontSize = "1000%";
})
...
// input.addEventListener("input", function(){
//   document.getElementsByClassName("tech").item(0).innerHTML = input.value;
// })
